...
Build a design editor with integrated [Getty Images](https://www.gettyimages.com/) premium stock photos — search and browse millions of high-quality images directly within your editor. Built with [CE.SDK](https://img.ly/creative-sdk) by [IMG.LY](https://img.ly), runs entirely in the browser with no server dependencies (except for the Getty Images API proxy).

<p>
  <a href="https://img.ly/docs/cesdk/starterkits/getty-images-editor/">Documentation</a> |
...
```bash
git clone https://github.com/imgly/starterkit-getty-images-editor-ts-web.git
cd starterkit-getty-images-editor-ts-web
```
...
```
starterkit-getty-images-editor-ts-web/
├── src/
...
│       └── plugins/
│           └── getty-images.ts  # Getty Images asset source plugin
